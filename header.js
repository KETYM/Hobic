...
<nav>
    ...
    <div class="nav-derecha">
        <form action="catalogo.html" method="GET" class="nav-search-box">
            ...
            <input type="text" name="buscar" placeholder="Buscar en Hobic..." class="nav-search-input" autocomplete="off">
        </form>
