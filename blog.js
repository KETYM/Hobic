...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if(sesion){
        ...
        let nombre = localStorage.getItem('usuario_nombre') || datosUsuario.correo.split('@')[0];
        ...
        if (userNavContainer) {
            ...
            document.getElementById('btn-logout-blog').addEventListener('click', function (e) {
                e.stopPropagation();
    ...
    let comentarios = JSON.parse(localStorage.getItem('hobic_guestbook')) || [
        { nombre: 'Churrasquin', mensaje: '¡Me encanta el diseño de este blog!', hora: '15:30' },
